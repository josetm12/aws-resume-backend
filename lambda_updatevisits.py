...
# Initialize a session using DynamoDB Local
session = boto3.Session(
    aws_access_key_id="acid", aws_secret_access_key="asa", region_name="us-west-2"
)

dynamodb = session.resource(
    "dynamodb", endpoint_url=os.getenv("DYNAMODB_ENDPOINT"), config=config
)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        return {
            ...
            "body": json.dumps(
                {"page": page, "visits": visit_count}, default=decimal_default
            ),
        }
